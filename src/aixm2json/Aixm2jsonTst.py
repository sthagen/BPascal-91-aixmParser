...
class Aixm2jsonTst:
    ...
    def tstGeojsonPosition(self):
        ...
        lat1, lon1 = self.oAixmTools.geo2coordinates("dd", None,
                                        latitude="494300.00N",
                                        longitude="0024007.00E")
        p1 = Point(lon1, lat1)
        geojson.append(self.oAixmTools.make_point(p1, "Point {0}".format(Point)))
        #print(p1)

        lat2, lon2 = self.oAixmTools.geo2coordinates("dd", None,
                                        latitude="494300N",
                                        longitude="0024007E")
        p2 = Point(lon2, lat2)
        geojson.append(self.oAixmTools.make_point(p2, "Point {0}".format(Point)))
        #print(p2)
        ...
        self.oAixmTools.writeGeojsonFile(__ClsName__ + "-Position", ret)
        return
    ...
    def tstGeojsonArcHorAntihor(self):
        ...
        #Ligne 1 : CWA
        lat, lon = self.oAixmTools.geo2coordinates("dd", None, latitude="480138.00N", longitude="0032614.00W")
        p1 = Point(lon, lat)
        lat, lon = self.oAixmTools.geo2coordinates("dd", None, latitude="474538.00N", longitude="0032624.00W")
        c1 = Point(lon, lat)
        radius = float(16*1852)       #1852 = Nautic Mile to meters
        #Ligne 2 : GRC
        lat, lon = self.oAixmTools.geo2coordinates("dd", None, latitude="474041.00N", longitude="0030347.00W")
        p2 = Point(lon, lat)
        #Ligne 3 : CWA
        lat, lon = self.oAixmTools.geo2coordinates("dd", None, latitude="472939.00N", longitude="0032534.00W")
        p3 = Point(lon, lat)
        lat, lon = self.oAixmTools.geo2coordinates("dd", None, latitude="474538.00N", longitude="0032624.00W")
        c3 = Point(lon, lat)
        #Ligne 4 : GRC
        lat, lon = self.oAixmTools.geo2coordinates("dd", None, latitude="475007.00N", longitude="0034916.00W")
        p4 = Point(lon, lat)

        #Tests Arc horaires
        g = self.oAixmTools.make_arc2(c1, p1, p2, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        g = self.oAixmTools.make_arc2(c3, p3, p4, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        """
        g = self.oAixmTools.make_arc2(c3, p1, p3, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        g = self.oAixmTools.make_arc2(c3, p2, p3, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g}

        g = self.oAixmTools.make_arc2(c3, p2, p4, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        g = self.oAixmTools.make_arc2(c3, p3, p1, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        g = self.oAixmTools.make_arc2(c3, p3, p2, radius=0.0, clockwiseArc=True)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})
        """
        ...
        """
        g = self.oAixmTools.make_arc2(c1, p2, p1, radius=0.0, clockwiseArc=False)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        g = self.oAixmTools.make_arc2(c3, p4, p3, radius=0.0, clockwiseArc=False)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})

        g = self.oAixmTools.make_arc2(c3, p3, p1, radius=0.0, clockwiseArc=False)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})
        ...
        self.oAixmTools.writeGeojsonFile(__ClsName__ + "-ArcHorAntihor", geojson)
        return
    ...
    def tstGeojsonZonesCTR_LORIENT(self):
        ...
        #Tracé des points
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p1)}
        geojson.append({"type":"Feature", "properties":{"name": "p1"}, "geometry":g})
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(c1)}
        geojson.append({"type":"Feature", "properties":{"name": "c1"}, "geometry":g})
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p2)}
        geojson.append({"type":"Feature", "properties":{"name": "p2"}, "geometry":g})
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p3)}
        geojson.append({"type":"Feature", "properties":{"name": "p3"}, "geometry":g})
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p4)}
        ...
        g = [self.oAixmTools.Point2array(p2), self.oAixmTools.Point2array(p3)]
        g = {"type":"LineString", "coordinates":g}
        ...
        g = [self.oAixmTools.Point2array(p4), self.oAixmTools.Point2array(p1)]
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        self.oAixmTools.writeGeojsonFile(__ClsName__ + "-CtrLORIENT", geojson)
        return
    ...
    def tstGeojsonObjects(self):
        ...
        #g = self.oAixmTools.make_circle_ortho(p1.x, p1.y, radius2k, Proj(proj="ortho", lat_0=p0.y, lon_0=p0.x))
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p0)}
        geojson.append({"type":"Feature", "properties":{"name": "Center"}, "geometry":g})
        g = self.oAixmTools.make_arc(p0, radius2k)
        g = {"type":"Polygon", "coordinates":[g]}
        ...
        g = self.oAixmTools.make_arc(p2, radius2k, 10.0, 135.0)
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc line 10°/135°"}, "geometry":g})
        g = self.oAixmTools.make_arc(p2, radius2k, 190.0, 300.0)
        ...
        self.oAixmTools.writeGeojsonFile(__ClsName__ + "-Objects", geojson)
        return
    ...
    def _tstGeojsonComplexeObjects(self, Pref, coef, detail=False):
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p11)}
        geojson.append({"type":"Feature", "properties":{"name": "Point 11, 1er rectangle"}, "geometry":g})
        p12 = Point(p11.x, p11.y-(0.05*coef))
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p12)}
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p13)}
        geojson.append({"type":"Feature", "properties":{"name": "Point 13, 3ieme du rectangle"}, "geometry":g})
        p14 = Point(p11.x+(0.1*coef), p11.y)
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p14)}
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p10)}
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(pCA)}
        geojson.append({"type":"Feature", "properties":{"name": "Arc Center"}, "geometry":g})
        g = self.oAixmTools.make_arc2(pCA, p111, p121, clockwiseArc=True)
        arc1=g
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(pA1)}
        geojson.append({"type":"Feature", "properties":{"name": "First Point of Arcs"}, "geometry":g})
        pA2 = Point(arc1[-1][0], arc1[-1][1])
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(pA2)}
        ...
        g =[self.oAixmTools.Point2array(pCA), self.oAixmTools.Point2array(p111)]
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})
        g =[self.oAixmTools.Point2array(pCA), self.oAixmTools.Point2array(p121)]
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        #Creation d'une ligne de contour
        g = [self.oAixmTools.Point2array(p121), self.oAixmTools.Point2array(p12)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p122s)}
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p122c)}
        geojson.append({"type":"Feature", "properties":{"name": "Centre d'arc anti-horaire"}, "geometry":g})

        #Poursuite de la ligne de raccrochage
        g = [self.oAixmTools.Point2array(p12), self.oAixmTools.Point2array(p122s)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        #Creation d'un arc anti-horaire
        g = self.oAixmTools.make_arc3(p122c, p122s, 0.0, -120.0, 45.0)
        arc1=g
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "Arc"}, "geometry":g})
        ...
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p122e)}
        geojson.append({"type":"Feature", "properties":{"name": "Last Point of Arcs"}, "geometry":g})

        p123 = Point(p122e.x+(0.03*coef), p122e.y)
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p123)}
        geojson.append({"type":"Feature", "properties":{"name": "Point de décallage"}, "geometry":g})

        p124 = Point(p123.x, p12.y)
        g = {"type":"Point", "coordinates":self.oAixmTools.Point2array(p124)}
        geojson.append({"type":"Feature", "properties":{"name": "Point de raccrochage"}, "geometry":g})

         #Creation de lignes de raccrochage
        g = [self.oAixmTools.Point2array(p122e), self.oAixmTools.Point2array(p123)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        #Poursuite de la ligne de contours
        g = [self.oAixmTools.Point2array(p123), self.oAixmTools.Point2array(p124)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        g = [self.oAixmTools.Point2array(p124), self.oAixmTools.Point2array(p13)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        g = [self.oAixmTools.Point2array(p13), self.oAixmTools.Point2array(p14)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})

        g = [self.oAixmTools.Point2array(p14), self.oAixmTools.Point2array(p11)]
        polygon = polygon + g
        g = {"type":"LineString", "coordinates":g}
        geojson.append({"type":"Feature", "properties":{"name": "line"}, "geometry":g})
